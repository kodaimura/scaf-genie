...
routes:
	$(DOCKER_COMPOSE_CMD) run --rm $(API_SERVICE) julia --project=. -e 'using Pkg; Pkg.instantiate(); using Genie; Genie.loadapp(); println("GET /health"); println("POST /api/auth/signup"); println("POST /api/auth/login"); println("POST /api/auth/refresh"); println("POST /api/auth/logout"); println("POST /api/auth/forgot-password"); println("GET /api/auth/reset-password/verify"); println("POST /api/auth/reset-password"); println("GET /api/accounts"); println("POST /api/accounts"); println("GET /api/accounts/me"); println("PUT /api/accounts/:target_account_id/password"); println("PUT /api/accounts/:target_account_id/disable"); println("PUT /api/accounts/:target_account_id/enable"); println("GET /api/accounts/:target_account_id"); println("PUT /api/accounts/:target_account_id")'
